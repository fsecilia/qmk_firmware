...
const uint16_t PROGMEM encoder_map[sizeof(keymaps)/sizeof(*keymaps)][NUM_ENCODERS][NUM_DIRECTIONS] = {
...
// reduce firmware size by overriding weak symbols to use these smaller functions
#ifndef MAGIC_ENABLE
